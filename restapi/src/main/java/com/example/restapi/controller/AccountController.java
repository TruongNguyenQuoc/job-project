...
public class AccountController {
    ...
    @PostMapping("/save")
    public ResponseEntity<RestResponseDTO> saveAccount(@Valid @RequestBody AccountDTO accountDTO, BindingResult bindingResult) {
...
//                    "account.email.success");
    ...
    private ResponseEntity<RestResponseDTO> sendErrors(BindingResult bindingResult) {
        RestResponseDTO restResponse = new RestResponseDTO();
